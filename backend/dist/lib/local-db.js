...
(0, node_fs_1.mkdirSync)((0, node_path_1.dirname)(env_1.env.localDatabasePath), { recursive: true });
(0, node_fs_1.mkdirSync)(env_1.env.localDataRoot, { recursive: true });
(0, node_fs_1.mkdirSync)(env_1.env.localDocumentsDir, { recursive: true });
exports.db = new better_sqlite3_1.default(env_1.env.localDatabasePath);
